...
gdjs.fineCode.GDBlankEmoteObjects1= [];
gdjs.fineCode.GDBlankEmoteObjects2= [];
gdjs.fineCode.GDptObjects1= [];
gdjs.fineCode.GDptObjects2= [];
gdjs.fineCode.GDprimo_9595nomeObjects1= [];
gdjs.fineCode.GDprimo_9595nomeObjects2= [];
gdjs.fineCode.GDprimo_9595ptObjects1= [];
gdjs.fineCode.GDprimo_9595ptObjects2= [];
gdjs.fineCode.GDsecondo_9595nomeObjects1= [];
gdjs.fineCode.GDsecondo_9595nomeObjects2= [];
gdjs.fineCode.GDsecondo_9595ptObjects1= [];
gdjs.fineCode.GDsecondo_9595ptObjects2= [];
gdjs.fineCode.GDterzo_9595nomeObjects1= [];
gdjs.fineCode.GDterzo_9595nomeObjects2= [];
gdjs.fineCode.GDterzo_9595ptObjects1= [];
gdjs.fineCode.GDterzo_9595ptObjects2= [];
gdjs.fineCode.GDpic_9595primoObjects1= [];
gdjs.fineCode.GDpic_9595primoObjects2= [];
gdjs.fineCode.GDpic_9595secondoObjects1= [];
gdjs.fineCode.GDpic_9595secondoObjects2= [];
gdjs.fineCode.GDpic_9595terzoObjects1= [];
gdjs.fineCode.GDpic_9595terzoObjects2= [];
gdjs.fineCode.GDlinkprimoObjects1= [];
gdjs.fineCode.GDlinkprimoObjects2= [];
gdjs.fineCode.GDlinksecondoObjects1= [];
...
gdjs.fineCode.mapOfGDgdjs_9546fineCode_9546GDHomeObjects1Objects = Hashtable.newFrom({"Home": gdjs.fineCode.GDHomeObjects1});
...
gdjs.copyArray(runtimeScene.getObjects("linkprimo"), gdjs.fineCode.GDlinkprimoObjects1);

let isConditionTrue_0 = false;
isConditionTrue_0 = false;
for (var i = 0, k = 0, l = gdjs.fineCode.GDlinkprimoObjects1.length;i<l;++i) {
    if ( gdjs.fineCode.GDlinkprimoObjects1[i].IsClicked((typeof eventsFunctionContext !== 'undefined' ? eventsFunctionContext : undefined)) ) {
        isConditionTrue_0 = true;
        gdjs.fineCode.GDlinkprimoObjects1[k] = gdjs.fineCode.GDlinkprimoObjects1[i];
        ++k;
    }
}
gdjs.fineCode.GDlinkprimoObjects1.length = k;
if (isConditionTrue_0) {
{gdjs.evtsExt__URLTools__Redirect.func(runtimeScene, "https://www.instagram.com/wakeup_.ale/", (typeof eventsFunctionContext !== 'undefined' ? eventsFunctionContext : undefined));
}}
...
gdjs.copyArray(runtimeScene.getObjects("linksecondo"), gdjs.fineCode.GDlinksecondoObjects1);

let isConditionTrue_0 = false;
isConditionTrue_0 = false;
for (var i = 0, k = 0, l = gdjs.fineCode.GDlinksecondoObjects1.length;i<l;++i) {
    if ( gdjs.fineCode.GDlinksecondoObjects1[i].IsClicked((typeof eventsFunctionContext !== 'undefined' ? eventsFunctionContext : undefined)) ) {
        isConditionTrue_0 = true;
        gdjs.fineCode.GDlinksecondoObjects1[k] = gdjs.fineCode.GDlinksecondoObjects1[i];
        ++k;
    }
}
...
gdjs.copyArray(runtimeScene.getObjects("linkterzo"), gdjs.fineCode.GDlinkterzoObjects1);

let isConditionTrue_0 = false;
isConditionTrue_0 = false;
for (var i = 0, k = 0, l = gdjs.fineCode.GDlinkterzoObjects1.length;i<l;++i) {
    if ( gdjs.fineCode.GDlinkterzoObjects1[i].IsClicked((typeof eventsFunctionContext !== 'undefined' ? eventsFunctionContext : undefined)) ) {
        isConditionTrue_0 = true;
        gdjs.fineCode.GDlinkterzoObjects1[k] = gdjs.fineCode.GDlinkterzoObjects1[i];
        ++k;
    }
}
...
let isConditionTrue_0 = false;
isConditionTrue_0 = false;
isConditionTrue_0 = gdjs.evtTools.input.cursorOnObject(gdjs.fineCode.mapOfGDgdjs_9546fineCode_9546GDHomeObjects1Objects, runtimeScene, true, false);
if (isConditionTrue_0) {
...
gdjs.fineCode.GDBlankEmoteObjects1.length = 0;
gdjs.fineCode.GDBlankEmoteObjects2.length = 0;
gdjs.fineCode.GDptObjects1.length = 0;
gdjs.fineCode.GDptObjects2.length = 0;
gdjs.fineCode.GDprimo_9595nomeObjects1.length = 0;
gdjs.fineCode.GDprimo_9595nomeObjects2.length = 0;
gdjs.fineCode.GDprimo_9595ptObjects1.length = 0;
gdjs.fineCode.GDprimo_9595ptObjects2.length = 0;
gdjs.fineCode.GDsecondo_9595nomeObjects1.length = 0;
gdjs.fineCode.GDsecondo_9595nomeObjects2.length = 0;
gdjs.fineCode.GDsecondo_9595ptObjects1.length = 0;
gdjs.fineCode.GDsecondo_9595ptObjects2.length = 0;
gdjs.fineCode.GDterzo_9595nomeObjects1.length = 0;
gdjs.fineCode.GDterzo_9595nomeObjects2.length = 0;
gdjs.fineCode.GDterzo_9595ptObjects1.length = 0;
gdjs.fineCode.GDterzo_9595ptObjects2.length = 0;
gdjs.fineCode.GDpic_9595primoObjects1.length = 0;
gdjs.fineCode.GDpic_9595primoObjects2.length = 0;
gdjs.fineCode.GDpic_9595secondoObjects1.length = 0;
gdjs.fineCode.GDpic_9595secondoObjects2.length = 0;
gdjs.fineCode.GDpic_9595terzoObjects1.length = 0;
gdjs.fineCode.GDpic_9595terzoObjects2.length = 0;
gdjs.fineCode.GDlinkprimoObjects1.length = 0;
gdjs.fineCode.GDlinkprimoObjects2.length = 0;
gdjs.fineCode.GDlinksecondoObjects1.length = 0;
